...
namespace PLM.Common
{
    ...
    {
        private static readonly List<PointerEventModel> pointerUpEvents = new List<PointerEventModel>();
        private static readonly List<PointerEventModel> pointerDownEvents = new List<PointerEventModel>();
